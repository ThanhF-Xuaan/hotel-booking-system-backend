...
@Schema(description = "Yêu cầu tạo mới quy tắc giá (PricingRule)")
public class PricingRuleCreateRequest {
    ...
    @FutureOrPresent(message = "PRICING_RULE_START_DATE_NOT_NULL")
    ...
    @FutureOrPresent(message = "PRICING_RULE_END_DATE_NOT_NULL")
